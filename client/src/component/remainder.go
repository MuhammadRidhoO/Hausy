...
// 	}
// }
// // func (h *handlerTransaction) GetNeedPayTransaction(w http.ResponseWriter, r *http.Request) {
// // 	w.Header().Set("Content-Type", "application/json")
...
// // 	// get transactions
// // 	transactions, err := h.TransactionRepository.GetNeedPayTransaction(userId, []string{"pending", "waiting"})
// // 	if err != nil {
// // 		w.WriteHeader(http.StatusInternalServerError)
// // 		json.NewEncoder(w).Encode(err.Error())
// // 		return
