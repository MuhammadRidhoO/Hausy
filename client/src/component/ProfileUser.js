...
function ProfileUser() {
    ...
    const handleSubmitProfileUser = useMutation(async (e) => {
        ...
        try {
            ...
            const dataEditProfileTenant = new FormData();
            dataEditProfileTenant.set("full_name", editProfile.full_name);
            dataEditProfileTenant.set("user_name", editProfile.user_name);
            dataEditProfileTenant.set("phone", editProfile.phone);
